...
{
    public partial class TablesAddedAboutCourse : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CourseThemeCourses", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseThemeCourses_CategoryId",
                table: "CourseThemeCourses",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_CourseThemeCourses_CourseId",
                table: "CourseThemeCourses",
                column: "CourseId");

            migrationBuilder.CreateIndex(
                name: "IX_CourseThemeCourses_CourseThemeId",
                table: "CourseThemeCourses",
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Date = table.Column<DateTime>(type: "datetime2", nullable: true, defaultValueSql: "dateadd(hour,4,getutcdate())"),
